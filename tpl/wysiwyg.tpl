...
<div class="tinyeditor">
	...
	<div class="tinyeditor-divider"></div><div class="tinyeditor-control" title="Insert Ordered List" style="background-position: 0px -300px;" ng-click="execCommand('insertorderedlist')"></div>
